module Ladb::LexaCut
  ...
  class Group < DataContainer
    ...
    attr_reader :id, :material_id, :material_name, :material_display_name, :material_color, :material_type, :material_type_strippedname, :material_description, :material_url, :material_grained, :material_length_increased, :material_width_increased, :material_thickness_increased, :material_is_1d, :material_is_2d, :material_is_virtual, :part_count, :std_available, :std_dimension_stipped_name, :std_dimension, :std_dimension_real, :std_dimension_rounded, :std_width, :std_thickness, :total_cutting_length, :total_cutting_area, :total_cutting_volume, :total_final_area, :invalid_final_area_part_count, :show_cutting_dimensions, :show_edges, :edge_decremented, :show_faces, :face_decremented, :parts
