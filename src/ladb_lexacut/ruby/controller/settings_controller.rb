module Ladb::LexaCut
  ...
  class SettingsController < Controller
    ...
    def dialog_settings_command(language: nil, font_size:, print_margin: Plugin::TABS_DIALOG_DEFAULT_PRINT_MARGIN, table_row_size: Plugin::TABS_DIALOG_DEFAULT_TABLE_ROW_SIZE)
      PLUGIN.set_language(language, true)
      PLUGIN.tabs_dialog_set_font_size(font_size, true)
