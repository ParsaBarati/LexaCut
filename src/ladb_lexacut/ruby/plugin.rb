module Ladb::OpenCutList
  ...
  class Plugin
    ...
    TABS_DIALOG_DEFAULT_FONT_SIZE = 0   # 0 = Auto (100%), 1 = Small (90%), 2 = Tiny (80%)
    ...
    def initialize
      ...
      @tabs_dialog_font_size = read_default(SETTINGS_KEY_DIALOG_FONT_SIZE, TABS_DIALOG_DEFAULT_FONT_SIZE)
      ...
      @tabs_dialog = UI::HtmlDialog.new(
          {
              ...
              :use_content_size => TABS_DIALOG_USE_CONTENT_SIZE,
          })
    ...
    def tabs_dialog_set_font_size(font_size, persist = false)
      @tabs_dialog_font_size = font_size
      write_default(SETTINGS_KEY_DIALOG_FONT_SIZE, font_size) if persist
    end
        ...
        return base_capabilities.merge(
          {
            ...
            :last_news_timestamp => @last_news_timestamp,
            :last_news_title => @last_news_title,
            :tabs_dialog_font_size => @tabs_dialog_font_size,
